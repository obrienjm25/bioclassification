...
PA_data<-colorGridData_top5[,c(-1,-71,-72)] #remove columns to create strictly sitexspecies PA matrix
...
colorGridData_top5$cl2[colorGridData_top5$cl==12]<-3
colorGridData_top5$cl2[colorGridData_top5$cl==1]<-4
colorGridData_top5$cl2[colorGridData_top5$cl==5]<-5


#Provide a name to each cluster associated with broad geomorphic features
colorGridData_top5$ecoregion[colorGridData_top5$cl==9]<- "Outer Shelf" 
colorGridData_top5$ecoregion[colorGridData_top5$cl==8]<- "Inner Shelf"
colorGridData_top5$ecoregion[colorGridData_top5$cl==12]<- "Grand Banks"
colorGridData_top5$ecoregion[colorGridData_top5$cl==1]<- "Slope"
colorGridData_top5$ecoregion[colorGridData_top5$cl==5]<- "Grand Banks: SW Margin"
...
names1<-c(paste("freq_", c("1_OS","2_IS",
                           "3_GB", "4_Slope", 
                           "5_SW_margin_GB"), sep=""))
names2<-c(paste("abund_", c("1_OS","2_IS",
                            "3_GB", "4_Slope", 
                            "5_SW_margin_GB"), sep=""))
names3<-c(paste("indval_", c("1_OS","2_IS",
                             "3_GB", "4_Slope", 
                             "5_SW_margin_GB"), sep=""))
